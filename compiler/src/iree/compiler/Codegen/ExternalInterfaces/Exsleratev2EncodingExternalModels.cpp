...
static FailureOr<Operation *> lowerExsleratev2ConvolutionOpWithEncoding(
  ...
  auto convTiles = exslTileFromPackedType(packedIn);
  int64_t convTileH = convTiles.first;
  int64_t convTileW = convTiles.second;
...
static FailureOr<Operation *> lowerExsleratev2PoolingOpWithEncoding(
  ...
  auto poolTiles = exslTileFromPackedType(packedIn);
  int64_t poolTileH = poolTiles.first;
  int64_t poolTileW = poolTiles.second;
